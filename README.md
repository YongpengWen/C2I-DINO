...
After downloading, keep the original files in the following layout:
...
The conversion commands below prepare the annotation files required by training and evaluation. RSVG already includes compatible annotations; to regenerate its annotation spans, run:
