...
The converted annotation directories are generated by the commands below. RSVG already includes compatible annotation files; to regenerate its annotation spans, run:
