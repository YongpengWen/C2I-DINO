...
class MDETRStyleRefCocoDataset(BaseDetDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for img_id in img_ids:
            ...
            if 'target_class' in raw_img_info:
                data_info['target_class'] = raw_img_info['target_class']
            if 'target_phrase' in raw_img_info:
                data_info['target_phrase'] = raw_img_info['target_phrase']
            if 'caption_suffix' in raw_img_info:
                data_info['caption_suffix'] = raw_img_info['caption_suffix']
