...
# Train the BERT language encoder with the paper's 0.1 LR multiplier.
optim_wrapper = dict(
    paramwise_cfg=dict(
        custom_keys={'language_model': dict(lr_mult=0.1)}))

# The paper reports the RSVG protocol at Pr@0.25 and Pr@0.5 (rather than the
...
work_dir = (
    ...
    'paper_rerun_bert_trainable_rsvg_1024_bs8_12e')
