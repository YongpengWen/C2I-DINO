_base_ = './grounding_dino_swin-t_finetune_opt_vg_official_split.py'
...
# /root/autodl-tmp/opt-rsvg location from the generic base config.
data_root = '/root/autodl-tmp/datasets/opt-rsvg'
...
work_dir = (
    ...
    'paper_rerun_bert_trainable_opt_rsvg_ms8_11_bs8_12e')
